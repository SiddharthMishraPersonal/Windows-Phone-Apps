...
namespace channel_connect
{
    ...
    public sealed partial class App : Application
    {
        ...
        public const string APP_NAME = "Channel Connect";
        ...
        {
            TileServices.CreateFlipTile(@"Channel Connect", @"Your app, your way!", @"DataImages/FlipSquareTile.jpg", "DataImages/FlipWideTile.jpg");
        }
        #endregion
    }
}
